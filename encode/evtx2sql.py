...
def EVTX2pkl(evtxpath,pklFilepath):
    '''
...
def EVTXtoSQL(evtxpath):
    ...
    line_all = df.shape[0]
    line_now = 0
    hostname = 'winserver2010-10.1.1.12'
    for data in df.values:
        line_now += 1
        progress_bar(line_now / line_all)

        index = {'channel': '', 'systmtime': '', 'eventid': '', 'level': '', 'targetuserName': '',
                 'targetdomainname': '',
                 'targetsid': '',
                 'subjectusersid': '', 'subjectusername': '', 'subjectdominename': '', 'subjectlogonid': '',
                 'callprocessname': '',
        ...
        sql = "INSERT INTO `{}`" \
              ...
              " '{}', '{}', '{}', '{}','{}'," \
              " '{}', '{}', '{}', '{}')".format(hostname,
            data[index['channel']], data[index['systemtime']], data[index['eventid']], data[index['level']],
            data[index['targetuserName']],
            data[index['targetdomainname']], data[index['targetsid']], data[index['subjectusersid']],
            data[index['subjectusername']], data[index['subjectdominename']],
            data[index['subjectlogonid']], data[index['targetusersid']], data[index['status']],
            data[index['substatus']], data[index['logontype']],
            data[index['logonprocessname']], data[index['workstationname']], data[index['processname']],
...
if __name__ == '__main__':
    EVTXtoSQL('../SelectedLogs/server2012/server.evtx')