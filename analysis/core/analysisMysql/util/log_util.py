...
from analysis.core.analysisMysql.util.excel_util import init_ws, write
from analysis.core.analysisMysql.util.mysql_util import get_columns
...
def get_command(d):
    command = 'mysqlbinlog  --base64-output="decode-rows" -v  logbin/' + d + ' >util/analyse.txt'
    index = d.index(".")
