...
#可以将alllog和list4624_4625存文件，但是处理时间特别长
    ...
    try:
        with open(evtxpath, 'r') as f:
            with contextlib.closing(mmap.mmap(f.fileno(), 0, access=mmap.ACCESS_READ)) as buf:
                ...
                #根据eventID来分别存储
                    #4624登陆成功,4625登陆失败
                    if content_dict['EventID']=='4624' and content_dict['IpAddress_EventData']!='-'and content_dict['TargetUserName_EventData']=='ANONYMOUS LOGON':
...
print(Log_Get('./SelectedLogs/server2012/server.evtx'))
