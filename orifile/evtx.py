        ...
        with open(evtxpath, 'r') as f:
            with contextlib.closing(mmap.mmap(f.fileno(), 0, access=mmap.ACCESS_READ)) as buf:
                ...
                for xml, record in evtx_file_xml_view(fh):
                    ...
                    #上方处理后的dict
# {'Channel': 'Security', 'SystemTime': '2022-04-14 22:34:34', 'EventID': '4799', 'Level': '0', 'UserID': '', 'Computer': '10_0_12_14'}
#                     print(content_dict)
                    ...
                    for data in domtree.getElementsByTagName('Data'):
                        if len(data.childNodes):
                            ...
                            #print(content_dict)
#{'Channel': 'Security', 'SystemTime': '2022-04-15 00:05:57', 'EventID': '4625', 'Level': '0', 'UserID': '', 'Computer': '10_0_12_14',
    # 'SubjectUserSid_EventData': 'S-1-0-0', 'SubjectUserName_EventData': '-', 'SubjectDomainName_EventData': '-',
    # 'SubjectLogonId_EventData': '0x0000000000000000', 'TargetUserSid_EventData': 'S-1-0-0', 'TargetUserName_EventData': 'ADMINISTRATOR',
    # 'Status_EventData': '0xc000006d', 'FailureReason_EventData': '%%2313', 'SubStatus_EventData': '0xc000006a', 'LogonType_EventData': '3',
    # 'LogonProcessName_EventData': 'NtLmSsp ', 'AuthenticationPackageName_EventData': 'NTLM', 'WorkstationName_EventData': '-', 'TransmittedServices_EventData': '-',
    # 'LmPackageName_EventData': '-', 'KeyLength_EventData': '0', 'ProcessId_EventData': '0x0000000000000000', 'ProcessName_EventData': '-',
    # 'IpAddress_EventData': '36.138.82.9', 'IpPort_EventData': '0'}
                        try:
                            print(content_dict['IpAddress_EventData'])
                            #可以成功提取IP地址
                        except:
                            continue
                    # 获取用户数据信息（UserData）
